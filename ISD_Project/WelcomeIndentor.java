...
public class WelcomeIndentor extends JFrame {
	 ...
	 * Create the frame.
	 */
	public WelcomeIndentor(String w) {
		...
		btnNewButton.setBounds(26, 58, 102, 23);
		...
		btnNewButton_1.setBounds(159, 58, 118, 23);
		...
		btnNewButton_2.setBounds(305, 58, 131, 23);
		getContentPane().add(btnNewButton_2);
		
		JLabel lblNewLabel = new JLabel("   WELCOME "+w+" !");
		lblNewLabel.setFont(new Font("Comic Sans MS", Font.BOLD, 20));
		lblNewLabel.setBounds(126, 11, 310, 36);
